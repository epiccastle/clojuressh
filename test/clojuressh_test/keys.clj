...
"
    :passphrase nil
    :fingerprint "SHA256:Hla79FyR9vandHlESZpuGSIFBb4LuxzMZQ4DKt7NXnI"
...
"
    ...
    :fingerprint "SHA256:rbnSuk0zz2sRHFs0eW09NV6DhQxoRJUjwat+AAtnIvU"
...
(defn create-key-pair [agent key-id]
  (key-pair/load-bytes
    agent
    (get-in keys [key-id :private])
    (get-in keys [key-id :public])))
